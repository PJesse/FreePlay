...
# 78 "../../Common/Minimal/blocktim.c" 2
...
# 79 "../../Common/Minimal/blocktim.c" 2
...
# 80 "../../Common/Minimal/blocktim.c" 2
...
# 83 "../../Common/Minimal/blocktim.c" 2
# 113 "../../Common/Minimal/blocktim.c"
...
void vCreateBlockTimeTasks( void )
{
 ...
 if( xTestQueue != 0 )
 {
  ...
  xTaskCreate( vPrimaryBlockTimeTestTask, "BTest1", ( 105 ), 0, ( ( 4 ) - 3 ), 0 );
  xTaskCreate( vSecondaryBlockTimeTestTask, "BTest2", ( 105 ), 0, ( ( 4 ) - 4 ), &xSecondary );
 }
}
...
TickType_t xTimeToBlock, xBlockedTime;
 ...
 for( ;; )
 {
  ...
  for( xItem = 0; xItem < ( 5 ); xItem++ )
  {
   ...
   if( xQueueGenericReceive( ( xTestQueue ), ( &xData ), ( xTimeToBlock ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 0 ) )
   {
...
# 279 "../../Common/Minimal/blocktim.c"
  ...
  for( xItem = 0; xItem < ( 5 ); xItem++ )
  {
   ...
   if( xQueueGenericReceive( ( xTestQueue ), ( &xData ), ( ( ( TickType_t ) 0 ) ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 1 ) ) )
   {
    xErrorOccurred = ( ( BaseType_t ) 1 );
   }
...
BaseType_t xData;
 ...
 for( ;; )
 {
  ...
  xRunIndicator = ( ( UBaseType_t ) 0x55 );
  if( xQueueGenericReceive( ( xTestQueue ), ( &xData ), ( ( 175 ) ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 0 ) )
  {
   xErrorOccurred = ( ( BaseType_t ) 1 );
  }
...
const TickType_t xPeriod = 75, xCycles = 5, xAllowableMargin = ( ( 15 ) >> 1 );



 vTaskPrioritySet( 0, ( ( 4 ) - 1 ) - 1 );
