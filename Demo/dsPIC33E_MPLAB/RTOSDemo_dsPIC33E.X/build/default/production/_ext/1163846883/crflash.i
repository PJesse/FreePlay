...
# 100 "../../Common/Minimal/crflash.c" 2
...
# 103 "../../Common/Minimal/crflash.c" 2
...
# 104 "../../Common/Minimal/crflash.c" 2
...
static const TickType_t xFlashRates[ 8 ] = { 150 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
 ...
 for( ;; )
 {
  ...
  { *( &xResult ) = xQueueCRSend( ( xFlashQueue) , ( ( void * ) &uxIndex) , ( 0 ) ); if( *( &xResult ) == ( -4 ) ) { ( ( CRCB_t * )( ( xHandle ) ) )->uxState = (193 * 2); return; case (193 * 2):; *&xResult = xQueueCRSend( ( xFlashQueue ), ( ( void * ) &uxIndex ), 0 ); } if( *&xResult == ( -5 ) ) { ( ( CRCB_t * )( ( xHandle ) ) )->uxState = ((193 * 2)+1); return; case ((193 * 2)+1):; *&xResult = ( ( ( BaseType_t ) 1 ) ); } };
  ...
  if( ( xFlashRates[ uxIndex ] ) > 0 ) { vCoRoutineAddToDelayedList( ( xFlashRates[ uxIndex ] ), 0 ); } ( ( CRCB_t * )( ( xHandle ) ) )->uxState = (203 * 2); return; case (203 * 2):;;
 }
...
UBaseType_t uxLEDToFlash;
 ...
 for( ;; )
 {
  ...
  { *( &xResult ) = xQueueCRReceive( ( xFlashQueue) , ( &uxLEDToFlash ), ( ( TickType_t ) 0xffff ) ); if( *( &xResult ) == ( -4 ) ) { ( ( CRCB_t * )( ( xHandle ) ) )->uxState = (225 * 2); return; case (225 * 2):; *( &xResult ) = xQueueCRReceive( ( xFlashQueue) , ( &uxLEDToFlash ), 0 ); } if( *( &xResult ) == ( -5 ) ) { ( ( CRCB_t * )( ( xHandle ) ) )->uxState = ((225 * 2)+1); return; case ((225 * 2)+1):; *( &xResult ) = ( ( ( BaseType_t ) 1 ) ); } };
