...
signed short xSerialGetChar( xComPortHandle pxPort, signed char *pcRxedChar, TickType_t xBlockTime )
{
 ...
 if( xQueueGenericReceive( ( xRxedChars ), ( pcRxedChar ), ( xBlockTime ), ( ( BaseType_t ) 0 ) ) )
 {
  return ( ( BaseType_t ) 1 );
 }
 else
