...
# 82 "../../Common/Minimal/integer.c" 2


# 1 "../../Common/include/integer.h" 1
# 73 "../../Common/include/integer.h"
void vStartIntegerMathTasks( UBaseType_t uxPriority );
BaseType_t xAreIntegerMathsTaskStillRunning( void );
# 85 "../../Common/Minimal/integer.c" 2
...
static volatile BaseType_t xTaskCheck[ ( 1 ) ] = { ( BaseType_t ) ( ( BaseType_t ) 0 ) };
...
short sTask;
 ...
 {
  xTaskCreate( vCompeteingIntMathTask, "IntMath", ( 105 ), ( void * ) &( xTaskCheck[ sTask ] ), uxPriority, ( TaskHandle_t * ) 0 );
 }
}
